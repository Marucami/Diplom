...
class RegisterView(APIView):
    ...
    @extend_schema(
        ...
        description="Создание нового пользователя системы",
...
class LoginView(APIView):
    ...
    @extend_schema(
        ...
        description="Авторизация пользователя через Session Authentication",
...
class TransactionView(APIView):
    ...
    @extend_schema(
        ...
        description="Создание доходной или расходной операции",
...
class AnalyticsView(APIView):
    ...
    @extend_schema(
        ...
        description="Возвращает данные доходов и расходов за последние 6 месяцев",
...
class ForecastView(APIView):
    ...
    @extend_schema(
        tags=["Forecast"],
        summary="Финансовый прогноз",
        description="Прогнозирование состояния бюджета пользователя",
        parameters=[
            OpenApiParameter(
                name="goal",
                type=float,
...
class AvailableBanksListView(APIView):
    ...
    @extend_schema(
        tags=["Reference"],
        summary="Список доступных банков",
    )
    def get(self, request):
